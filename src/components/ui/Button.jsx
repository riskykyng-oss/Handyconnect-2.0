...
export default function Button({
  ...
  const styles = {
    ...
    secondary: 'bg-hc-brand-100 text-hc-ink hover:bg-hc-brand-200',
    ghost: 'bg-transparent text-hc-ink-2 hover:bg-hc-brand-50',
    outline: 'border border-hc-hairline bg-white text-hc-ink-2 hover:bg-hc-brand-50',
