const STYLES = {
  ...
  assigned: 'bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-300',
  ...
  client: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-400',
  handyman: 'bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-300',
