  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="pointer-events-none absolute -right-20 -top-20 h-[280px] w-[280px] rounded-full bg-white opacity-[0.08] blur-[120px]"
      />
      <motion.div
        animate={{ x: [0, -8, 0], y: [0, 8, 0] }}
        transition={{ duration: 4, repeat: Infinity, repeatType: 'mirror', ease: 'easeInOut' }}
        className="pointer-events-none absolute -bottom-16 -left-8 h-[160px] w-[160px] rounded-full bg-white opacity-[0.06] blur-[90px]"
      />
      ...
      <div className="relative z-10 flex h-full items-center px-6 md:px-8 lg:px-10">
        <div className="w-full max-w-xl">
          <p
            className="font-semibold leading-[110%] tracking-[-0.03em] text-white text-[28px] md:text-[34px] lg:text-[40px]"
          ...
          <div className="flex flex-wrap gap-3">
            ...
            >
              <div>
                <p className="font-display text-[22px] font-semibold leading-none text-white">New</p>
